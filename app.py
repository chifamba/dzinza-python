...
LOG_DIR = os.path.join(APP_ROOT, 'logs') # Separate log directory
USERS_FILE = os.path.join(DATA_DIR, 'users.json')
FAMILY_TREE_FILE = os.path.join(DATA_DIR, 'family_tree.json')
AUDIT_LOG_FILE = os.path.join(DATA_DIR, 'audit.log') # Keep audit log in data
APP_LOG_FILE = os.path.join(LOG_DIR, 'app.log') # App log file
