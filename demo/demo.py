...
def load_demo_data():
    ...
    num_generations_to_create = random.randint(4, 6)  # Create 4 to 6 additional generations for larger families
    ...
    for gen_num in range(num_generations_to_create):
        ...
        for father, mother in current_generation_couples:
            num_children = random.randint(3, 6)  # Increased number of children per couple
